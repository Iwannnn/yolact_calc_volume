...
iwan_box_dataset = dataset_base.copy(
    {
        "name": "Goods_box_Dataset",
        "train_images": "./data/goods_dataset",
        "train_info": "./data/goods_dataset/annotations.json",
        "valid_images": "./data/goods_dataset",
        "valid_info": "./data/goods_dataset/annotations.json",
        "has_gt": True,
        "class_names": ("goods"),
        "label_map": {1: 1},
    }
...
yolact_base_config = coco_base_config.copy(
    {
        ...
        "max_size": 550,
        # Training params
        "lr_steps": (2800, 6000, 7000, 7500),  # 学习率衰减区间
        "max_iter": 1600,  # 最大迭代次数
        # Backbone Settings
